...
const recipesToMigrate = [
 {
  ...
  isActive: true,
  isHalal: true,
  description: "A quick Maggi instant noodles meal upgraded with a protein-packed egg. Ready in under 5 minutes with minimal ingredients. Great for late night cravings or busy mornings.",
  category: "Anytime",
  subCategory: "student",
  ...
  pantryKeywords: ["maggi", "egg", "water", "oil", "butter", "salt", "pepper"],
  searchKeywords: ["maggi", "maggi egg", "instant noodles", "quick noodles", "student food", "easy meal", "egg noodles", "budget food", "fast food"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A filling and protein-rich omelette sandwich made with spiced eggs, onion, tomato, and green chili served between toasted bread slices. A great student breakfast or quick snack ready in 10 minutes.",
  category: "Breakfast",
  subCategory: "student",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner", "Snack"],
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["egg", "bread", "onion", "tomato", "green chili", "coriander", "oil", "butter", "salt", "pepper"],
  searchKeywords: ["omelette sandwich", "egg sandwich", "bread omelette", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "egg toast", "desi sandwich"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "The quickest student meal ever — instant cup noodles ready in just 3 minutes. Customize with spring onions, soy sauce, or chili flakes for extra flavor. Great for hostel life and late-night hunger.",
  category: "Anytime",
  subCategory: "student",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner", "Snack"],
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["noodles", "instant noodles", "water", "spring onion", "soy sauce", "chili flakes"],
  searchKeywords: ["cup noodles", "instant noodles", "quick noodles", "student food", "easy meal", "budget food", "fast meal", "hostel food", "3 minute noodles"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["bread", "butter", "jam", "honey", "cheese"],
  searchKeywords: ["butter toast", "bread toast", "toast with butter", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "crispy toast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A fresh and tangy Pakistani-style fruit chaat with mixed seasonal fruits tossed in chaat masala, black salt, and lemon juice. Light, healthy, and refreshing — a great student snack or iftar treat.",
  category: "Snacks",
  subCategory: "student",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Snack"],
  ...
  pantryKeywords: ["apple", "banana", "orange", "pomegranate", "chaat masala", "black salt", "lemon", "mint"],
  searchKeywords: ["fruit chaat", "fruit salad", "fruit mix", "student snack", "healthy snack", "quick snack", "budget food", "easy snack", "pakistani chaat"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A healthy and creamy yogurt bowl topped with fresh seasonal fruits, honey, and a hint of cardamom. Nutritious, filling, and ready in 5 minutes — a great student breakfast or healthy snack.",
  category: "Breakfast",
  subCategory: "student",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Snack"],
  ...
  searchKeywords: ["yogurt fruit bowl", "fruit yogurt", "yogurt with fruits", "healthy breakfast", "student breakfast", "quick breakfast", "easy meal", "budget food", "fruit bowl"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["cereal", "cornflakes", "milk", "sugar", "honey", "banana"],
  searchKeywords: ["cereal milk", "cornflakes milk", "breakfast cereal", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "cold cereal", "no cook meal"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A nutritious and filling peanut butter toast ready in 5 minutes. High in protein and healthy fats — top with honey, banana, or cinnamon for extra flavor. A great student breakfast or post-study snack.",
  category: "Breakfast",
  subCategory: "student",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Snack"],
  ...
  searchKeywords: ["peanut butter toast", "peanut butter bread", "toast with peanut butter", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "protein toast", "healthy toast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["bread", "jam", "butter", "sugar"],
  searchKeywords: ["jam sandwich", "bread jam", "fruit jam sandwich", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "sweet sandwich", "no cook meal"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowfat"],
  pantryKeywords: ["egg", "salt", "pepper", "chaat masala", "soy sauce", "water"],
  searchKeywords: ["boiled eggs", "hard boiled eggs", "soft boiled eggs", "egg boil", "student snack", "protein snack", "easy snack", "budget food", "egg breakfast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["bread", "egg", "milk", "sugar", "cinnamon", "butter", "oil", "honey", "syrup"],
  searchKeywords: ["french toast", "egg toast", "sweet toast", "bread egg toast", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "continental breakfast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowfat"],
  pantryKeywords: ["egg", "milk", "butter", "oil", "salt", "pepper", "onion", "tomato", "green chili"],
  searchKeywords: ["scrambled eggs", "egg scramble", "fluffy eggs", "egg bhurji", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "creamy eggs"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["paratha", "aloo paratha", "oil", "ghee", "yogurt", "pickle", "chutney", "butter"],
  searchKeywords: ["aloo paratha", "potato paratha", "stuffed paratha", "paratha with potato", "student breakfast", "quick breakfast", "easy breakfast", "budget food", "desi breakfast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowfat"],
  pantryKeywords: ["chickpeas", "chana", "onion", "tomato", "cucumber", "green chili", "coriander", "chaat masala", "cumin", "lemon"],
  searchKeywords: ["chana chaat", "chickpea chaat", "chana salad", "chickpea salad", "student snack", "healthy snack", "quick snack", "budget food", "pakistani chaat"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A fresh and healthy vegetable sandwich layered with boiled potato, cucumber, tomato, and onion, spread with green chutney or mayonnaise. Light, filling, and ready in 10 minutes — great for campus lunch.",
  category: "Lunch",
  subCategory: "student",
  dietType: "Vegetarian",
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["bread", "potato", "cucumber", "tomato", "onion", "lettuce", "butter", "chutney", "mayonnaise", "salt", "pepper"],
  searchKeywords: ["vegetable sandwich", "veg sandwich", "veggie sandwich", "student lunch", "quick lunch", "easy lunch", "budget food", "healthy sandwich", "desi sandwich"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["pasta", "penne", "macaroni", "spaghetti", "tomato sauce", "oil", "butter", "oregano", "chili flakes", "cheese"],
  searchKeywords: ["pasta tomato sauce", "pasta with sauce", "simple pasta", "tomato pasta", "student lunch", "quick lunch", "easy dinner", "budget food", "italian pasta"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["rice", "egg", "peas", "carrots", "corn", "onion", "soy sauce", "oil", "spring onion"],
  searchKeywords: ["fried rice", "chinese fried rice", "egg fried rice", "leftover rice", "rice fry", "student lunch", "quick dinner", "easy meal", "budget food"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowfat"],
  pantryKeywords: ["dal", "lentils", "masoor dal", "rice", "chawal", "turmeric", "ghee", "oil", "cumin", "red chili"],
  searchKeywords: ["daal chawal", "dal chawal", "lentils rice", "dal rice", "masoor dal", "student lunch", "quick dinner", "easy meal", "budget food", "pakistani food", "comfort food"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "A hearty and filling chicken sandwich made with shredded chicken mixed in creamy mayonnaise, layered with lettuce and toasted golden in butter. Great for using leftover chicken — a quick student lunch.",
  category: "Lunch",
  subCategory: "student",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Snack"],
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["bread", "chicken", "mayonnaise", "onion", "lettuce", "butter", "salt", "pepper"],
  searchKeywords: ["chicken sandwich", "shredded chicken sandwich", "chicken mayo sandwich", "student lunch", "quick lunch", "easy lunch", "budget food", "toasted sandwich", "leftover chicken"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
{
  ...
  ageGroup: ["adults", "teens", "kids"],
  patientFriendly: ["general"],
  pantryKeywords: ["paratha", "qeema", "minced meat", "keema", "onion", "green chili", "oil", "garam masala", "coriander"],
  searchKeywords: ["qeema paratha", "keema paratha", "minced meat paratha", "stuffed paratha", "paratha with meat", "student breakfast", "quick breakfast", "easy meal", "budget food", "desi breakfast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
