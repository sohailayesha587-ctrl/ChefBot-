...
const recipesToMigrate = [
 {
  ...
  stepsRaw: [
    "Clean and wash the fish pieces well. Pat them dry with paper towels. Apply 1/2 teaspoon of turmeric powder and a pinch of salt to the fish pieces. Set aside for 15 minutes.",
    "Heat oil in a deep pan over medium heat. Add cumin seeds and let them crackle for 30 seconds until they smell good.",
    ...
    "Add 1 cup of warm water and bring to a boil. Lower the heat and simmer for 5 minutes.",
  ...
  isActive: true,
  isHalal: true,
  description: "Classic Pakistani tangy and spicy fish curry with a rich tomato-onion gravy – great with steamed rice.",
  category: "Dinner",
...
},
{
  ...
  stepsRaw: [
    "Marinate the fish pieces with 1/2 teaspoon of turmeric powder and salt. Set aside for 15 minutes.",
    ...
    "Gently add the fish pieces and cook for 8-10 minutes until the fish is done.",
  ...
  isActive: true,
  isHalal: true,
  description: "Bold and tasty spicy fish masala gravy with a rich onion-tomato base – a Pakistani classic.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Add coconut milk and bring to a gentle simmer. Do not boil vigorously or the coconut milk may curdle.",
  ...
  isActive: true,
  isHalal: true,
  description: "South Indian-style creamy fish curry with coconut milk, mustard seeds, and curry leaves – mild yet tasty.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "Restaurant-style kadhai fish curry with capsicum and a rich masala – great with naan or roti.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Marinate the fish with turmeric and salt. Set aside for 15 minutes.",
    "Heat oil in a pan over medium heat. Add cumin seeds and let them crackle for 30 seconds.",
    "Add half of the sliced onions and cook for 6-7 minutes until golden brown.",
    "Add ginger-garlic paste and cook for 2 minutes until it smells good.",
    "Add chopped tomatoes and cook for 5-6 minutes until soft.",
    "Add turmeric powder, red chili powder, and salt. Mix well and cook for 2-3 minutes.",
    "Add 1/2 cup of warm water and bring to a simmer.",
    "Gently add the fish pieces and the remaining raw sliced onions.",
    "Cook for 8-10 minutes until the fish is done.",
  ...
  isActive: true,
  isHalal: true,
  description: "Sweet and savory fish curry with double onions – half cooked, half raw for a special texture.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Heat the remaining oil in a wok or pan over high heat. Add cumin seeds and let them crackle.",
    "Add sliced onions and cook for 2 minutes until soft but still crunchy.",
...
},
{
  ...
  stepsRaw: [
    "Marinate the fish with turmeric and salt. Set aside for 15 minutes.",
    "Heat oil in a pan over medium heat. Add cumin seeds and let them crackle for 30 seconds.",
    "Add finely chopped onions and cook for 5-6 minutes until soft and see-through.",
    "Add ginger-garlic paste and cook for 2 minutes until it smells good.",
    ...
    "Lower the heat. Add cream and stir gently. Do not boil after adding cream.",
    "Simmer for 5 minutes on low heat.",
    "Garnish with fresh coriander leaves and serve hot with naan or roti."
  ],
  difficulty: "Medium",
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "Special and tasty fish kofta curry – soft fish balls in a spicy, aromatic gravy.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Clean the fish pieces and make 2-3 shallow cuts on each piece so the marinade can go inside.",
    ...
    "Apply this marinade generously to all fish pieces. Cover and put in the fridge for 30 minutes.",
  ...
  isActive: true,
  isHalal: true,
  description: "Crispy, golden fried fish with a spiced rice flour coating – a great starter or snack.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Wash the fish slices and pat them dry with paper towels. Make cuts on both sides.",
    ...
    "Apply this marinade to the fish slices. Cover and put in the fridge for 30-45 minutes.",
...
},
{
  ...
  stepsRaw: [
    "Clean the fish pieces and pat them dry. Make shallow cuts on both sides.",
  ...
  isActive: true,
  isHalal: true,
  description: "Simple and healthy griddle-fried fish with a light spice marinade – great for a quick meal.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Clean the fish pieces well and pat them dry. Make deep cuts on both sides.",
    "In a bowl, mix ginger-garlic paste, red chili powder, turmeric powder, cumin powder, pepper powder, lemon juice, and salt.",
    "Apply this spicy marinade generously to all fish pieces, making sure it gets into the cuts.",
    "Cover and put in the fridge for 1 hour for the best results.",
  ...
  isActive: true,
  isHalal: true,
  description: "Very hot and tasty Andhra-style fish fry with a bold spice blend – for heat lovers.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Pat the fish strips dry with paper towels. Season with salt and pepper on both sides.",
    ...
    "Take one fish strip and coat it in the flour mixture, shaking off the extra.",
    ...
    "Place the coated fish fingers on a plate and repeat with the remaining strips.",
    "Heat oil in a deep pan over medium heat for deep frying.",
  ...
  isActive: true,
  isHalal: true,
  description: "Crispy, golden fish fingers – a kids' favorite, great as a snack or appetizer with dipping sauce.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
  ...
  stepsRaw: [
    ...
    "Add the fish cubes to the marinade. Mix gently to coat all pieces. Cover and put in the fridge for 2 hours.",
    "If using wooden skewers, soak them in water for 30 minutes to prevent burning.",
    "Thread the marinated fish cubes onto skewers, alternating with capsicum and onion cubes.",
    "Preheat the oven to 400°F (200°C) or heat a grill or tawa.",
    "If using oven: Place the skewers on a baking tray lined with foil. Bake for 12-15 minutes, turning once halfway.",
    "If using tawa: Cook on medium heat, turning often, until charred and cooked through.",
  ...
  isActive: true,
  isHalal: true,
  description: "Smoky and tasty grilled fish tikka marinated in spiced yogurt with capsicum and onions – a great appetizer.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Add the fish cubes and mix gently to coat. Cover and put in the fridge for 2 hours.",
    "Soak wooden skewers in water for 30 minutes.",
    "Thread the marinated fish onto skewers.",
    "Preheat the oven to 400°F (200°C) or heat a grill.",
    "Cook for 12-15 minutes until the fish is cooked and lightly charred.",
...
},
{
  ...
  stepsRaw: [
    ...
    "Add the fish cubes and mix well. Cover and put in the fridge for 2 hours.",
    "Soak skewers in water for 30 minutes.",
    "Thread the marinated fish onto skewers.",
    "Preheat the oven to 400°F (200°C) or heat a grill.",
    "Cook for 12-15 minutes until the fish is done and slightly charred.",
  ...
  isActive: true,
  isHalal: true,
  description: "Herby, fresh green marinated fish tikka with mint, coriander, and green chilies – bright and tasty.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Preheat the oven to 400°F (200°C) or heat a grill.",
    "Cook for 10-12 minutes, turning now and then, until the fish is charred and cooked.",
    "Brush with oil while cooking to keep it moist.",
    "Serve hot with mint chutney, onion rings, and lemon wedges."
  ],
  difficulty: "Medium",
  cookingTime: 150,
...
},
{
  ...
  stepsRaw: [
    "Wash the basmati rice well and soak in water for 30 minutes. Drain before using.",
    "Lightly fry the fish pieces in 2 tablespoons of oil until golden. Remove and set aside.",
    "Heat the remaining oil in a large pot over medium heat. Add whole spices (cloves, cardamom, cinnamon) and cumin seeds. Cook for 30 seconds until they smell good.",
    "Add sliced onions and cook for 6-7 minutes until golden brown.",
    "Add ginger-garlic paste and cook for 2 minutes until it smells good.",
    "Add chopped tomatoes and cook for 5-6 minutes until soft.",
    "Add salt and 3 cups of warm water. Bring to a boil.",
    "Add the soaked and drained rice. Cook on high heat for 5-7 minutes until the rice is 70% done.",
    "Lower the heat. Gently place the fried fish pieces on top of the rice.",
    "Sprinkle garam masala and garnish with fresh coriander leaves.",
  ...
  isActive: true,
  isHalal: true,
  description: "Fragrant one-pot fish pulao with basmati rice and whole spices – a tasty, aromatic meal.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Heat oil in a large pot. Add whole spices and cook for 30 seconds.",
    "Add sliced onions and cook until golden brown.",
    "Add ginger-garlic paste and cook for 2 minutes.",
    "Add tomatoes and cook until soft.",
    "Add biryani masala and salt. Cook for 2 minutes.",
    "Add 3 cups of water and bring to a boil.",
    "Add the rice and cook until 70% done (about 5-7 minutes). Drain the excess water.",
  ...
  isActive: true,
  isHalal: true,
  description: "Aromatic and tasty fish biryani with fried fish, whole spices, and saffron – a royal dish.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Heat the remaining oil in a wok or large pan over high heat. Add chopped onions and cook for 1-2 minutes.",
    "Add diced carrots and green peas. Stir-fry for 2-3 minutes until the vegetables are tender-crisp.",
    "Add the cooked rice and break up any clumps. Mix well.",
    "Add soy sauce and salt. Mix well and cook for 2-3 minutes.",
...
},
{
  ...
  stepsRaw: [
    "Pat the fish cubes dry with paper towels. Set aside.",
  ...
  isActive: true,
  isHalal: true,
  description: "Crispy, golden fish fritters coated in spiced gram flour batter – a great tea-time snack.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Dip the fish cubes in the batter and coat well.",
  ...
  isActive: true,
  isHalal: true,
  description: "Indo-Chinese style sweet and spicy fish manchurian – crispy fish in a tangy, tasty sauce.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
  ...
  stepsRaw: [
    ...
    "In a large bowl, mix the mashed fish, mashed potatoes, chopped onions, green chilies, ginger paste, red chili powder, pepper powder, and salt.",
  ...
  isActive: true,
  isHalal: true,
  description: "Crispy, golden fish cutlets made with mashed fish and potatoes – a great appetizer for any occasion.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "Soft, tasty fish seekh kebabs with aromatic spices – a tasty seafood starter.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  isActive: true,
  isHalal: true,
  description: "Very tasty spicy masala-coated fish fry – crispy outside, juicy inside.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    ...
    "Add the fish cubes and mix well to coat. Marinate for 1 hour.",
    "Heat oil in a deep pan over medium heat for deep frying.",
    "Deep fry the marinated fish cubes until golden and crispy, about 4-5 minutes. Remove and set aside.",
    "In a small pan, heat 1 tablespoon of oil. Add mustard seeds and curry leaves. Let them crackle.",
...
},
{
  ...
  stepsRaw: [
    "Coat the fish cubes with cornflour, salt, and pepper. Deep fry until golden and crispy. Set aside.",
    "Heat 2 tablespoons of oil in a wok. Add ginger-garlic paste and cook for 1 minute.",
    "Add sliced onions, capsicum, and green chilies. Stir-fry on high heat for 2 minutes.",
    "Add soy sauce, chili sauce, vinegar, and 1/2 cup of water. Bring to a boil.",
...
},
{
  ...
  stepsRaw: [
    "Prepare the fish fingers by following the fish finger recipe and keep them ready.",
    "Warm the parathas on a tawa until soft and flexible.",
  ...
  isActive: true,
  isHalal: true,
  description: "Fish kathi roll with crispy fish fingers, fresh veggies, and mint mayo – a great street food snack.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Prepare the fish fingers and keep them ready.",
  ...
  isActive: true,
  isHalal: true,
  description: "Quick and tasty grilled fish sandwich with crispy fish fingers, lettuce, tomato, and creamy mayo.",
  category: "Dinner",
  subCategory: "fish-dish",
  dietType: "Non-Vegetarian",
  suitableForMeals: ["Lunch", "Dinner"],
...
},
{
  ...
  stepsRaw: [
    "Clean the fish bones and head well.",
    "In a large pot, add the fish bones, chopped onion, ginger slices, crushed garlic, and 4 cups of water.",
...
},
{
  ...
  stepsRaw: [
    "Heat oil in a large pot. Add chopped onions and cook for 2-3 minutes.",
