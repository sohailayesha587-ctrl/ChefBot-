...
image: "tawa-roti.jpg",
  ...
  isActive: true,
  isHalal: true,
  description: "Soft and fluffy whole wheat flatbread made on a griddle - a daily bread in Pakistani homes. Perfect with any curry or dal.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  ...
  pantryKeywords: ["flour", "salt", "oil", "ghee", "water"],
  searchKeywords: ["tawa roti", "roti", "flatbread", "pakistani bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Soft, puffed whole wheat flatbread cooked directly on an open flame - a classic Pakistani bread that is light and tasty.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner", "Snack"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "salt", "oil", "ghee"],
  searchKeywords: ["phulka", "roti", "puffed roti", "chapati", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Healthy gluten-free sorghum flatbread - a nutritious traditional bread. Good for people who want a healthy option.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner", "Snack"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["jowar flour", "salt", "oil", "ghee"],
  searchKeywords: ["jowar roti", "sorghum bread", "gluten free roti", "healthy bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
 {
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["bajra flour", "salt", "ghee"],
  searchKeywords: ["bajra roti", "pearl millet bread", "winter bread", "gluten free roti", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Classic layered whole wheat paratha - crispy, flaky, and perfect with chai, curry, or yogurt. A favorite in every home.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  ...
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "salt", "oil", "ghee"],
  searchKeywords: ["paratha", "simple paratha", "layered paratha", "crispy bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Restaurant-style flaky lachha paratha made with all-purpose flour - many layers, crispy outside, soft inside. Very special.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "maida", "salt", "oil", "ghee"],
  searchKeywords: ["lachha paratha", "layered paratha", "flaky bread", "paratha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
 {
  ...
  isActive: true,
  isHalal: true,
  description: "Classic stuffed paratha with spiced mashed potatoes - perfect for breakfast or any meal. Everyone loves this.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "potato", "onion", "green chili", "cumin", "red chili", "garam masala", "amchur", "coriander", "ghee"],
  searchKeywords: ["aloo paratha", "potato paratha", "stuffed paratha", "breakfast bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Healthy cauliflower stuffed paratha - lightly spiced and perfect for a wholesome meal. Very tasty.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "cauliflower", "onion", "green chili", "cumin seeds", "red chili", "garam masala", "amchur"],
  searchKeywords: ["gobhi paratha", "cauliflower paratha", "stuffed paratha", "healthy paratha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Unique and tasty radish stuffed paratha - a traditional Punjabi favorite, best enjoyed with butter.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "radish", "mooli", "onion", "green chili", "cumin", "red chili", "garam masala"],
  searchKeywords: ["mooli paratha", "radish paratha", "stuffed paratha", "winter paratha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
 {
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "paneer", "onion", "green chili", "cumin", "red chili", "garam masala", "coriander", "ghee"],
  searchKeywords: ["paneer paratha", "cheese paratha", "protein paratha", "stuffed paratha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "maida", "yogurt", "yeast", "sugar", "oil", "butter", "nigella seeds"],
  searchKeywords: ["naan", "tandoori naan", "soft naan", "restaurant bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "yeast", "butter", "garlic", "coriander"],
  searchKeywords: ["garlic naan", "butter naan", "restaurant naan", "naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
 {
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "yeast", "sugar", "oil", "butter"],
  searchKeywords: ["butter naan", "soft naan", "plain naan", "naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "yeast", "cheese", "butter", "oregano"],
  searchKeywords: ["cheese naan", "stuffed naan", "kids naan", "naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  pantryKeywords: ["flour", "yogurt", "coconut", "almonds", "pistachios", "raisins", "sugar", "cardamom", "butter"],
  searchKeywords: ["peshawari naan", "sweet naan", "nutty naan", "stuffed naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Traditional sesame naan - soft, rich, and topped with sesame seeds, brushed with butter. Very popular.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "yeast", "sugar", "oil", "sesame seeds", "butter"],
  searchKeywords: ["roghni naan", "sesame naan", "traditional naan", "naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "yeast", "sugar", "oil", "nigella seeds", "butter"],
  searchKeywords: ["kabuli naan", "afghan naan", "naan", "bread", "rustic bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart", "bp", "lowsalt", "lowfat"],
  pantryKeywords: ["flour", "yogurt", "baking powder", "sugar", "oil", "milk", "sesame seeds", "butter"],
  searchKeywords: ["roghni naan", "homestyle naan", "quick naan", "naan", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "milk", "sugar", "ghee", "saffron", "cardamom", "yeast"],
  searchKeywords: ["sheermal", "saffron bread", "sweet bread", "mughlai bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "milk", "sugar", "ghee", "saffron", "cardamom", "yeast", "poppy seeds"],
  searchKeywords: ["kashmiri sheermal", "saffron bread", "sweet bread", "kashmiri bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
...
},
 {
  ...
  isActive: true,
  isHalal: true,
  description: "Soft and fluffy leavened flatbread - perfect with chole, curries, or as a breakfast bread.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner", "Snack"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "yogurt", "baking powder", "sugar", "oil", "milk", "butter"],
  searchKeywords: ["kulcha", "plain kulcha", "soft kulcha", "bread", "chole kulcha"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "yogurt", "potato", "onion", "green chili", "cumin seeds", "red chili", "amchur", "coriander", "butter"],
  searchKeywords: ["aloo kulcha", "potato kulcha", "stuffed kulcha", "kulcha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "yogurt", "paneer", "onion", "green chili", "cumin", "red chili", "garam masala", "coriander", "butter"],
  searchKeywords: ["paneer kulcha", "cheese kulcha", "stuffed kulcha", "kulcha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  searchKeywords: ["bread pakora", "bread fritters", "snack", "pakistani snack", "tea time"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  searchKeywords: ["aloo bread pakora", "potato pakora", "stuffed pakora", "snack", "street food"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  pantryKeywords: ["bread", "butter", "potato", "cucumber", "tomato", "onion", "chaat masala", "chutney", "ketchup"],
  searchKeywords: ["grilled sandwich", "vegetable sandwich", "toast", "snack", "breakfast"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes"],
  pantryKeywords: ["bread", "butter", "potato", "cucumber", "tomato", "onion", "capsicum", "chutney", "chaat masala", "cheese"],
  searchKeywords: ["bombay sandwich", "mumbai sandwich", "grilled sandwich", "chaat sandwich", "snack"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  searchKeywords: ["cheese sandwich", "grilled cheese", "kids snack", "quick snack", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  searchKeywords: ["bread roll", "potato roll", "crispy roll", "snack", "pakistani snack"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  searchKeywords: ["veg bread roll", "vegetable roll", "crispy roll", "healthy snack", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "jaggery", "coconut", "nuts", "cardamom", "ghee"],
  searchKeywords: ["meetha paratha", "sweet paratha", "dessert bread", "jaggery paratha", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "banana", "sugar", "oil", "baking soda", "vanilla", "walnuts", "salt"],
  searchKeywords: ["banana bread", "sweet bread", "moist bread", "breakfast bread", "snack"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  isActive: true,
  isHalal: true,
  description: "Puffy, golden deep-fried bread - crispy outside, soft inside. Best served with aloo sabzi or chole.",
  category: "Anytime",
  subCategory: "bread",
  dietType: "Vegetarian",
  suitableForMeals: ["Breakfast", "Lunch", "Dinner"],
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "salt", "oil"],
  searchKeywords: ["puri", "deep fried bread", "fried bread", "breakfast bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "semolina", "yogurt", "baking powder", "sugar", "oil"],
  searchKeywords: ["bhatura", "chole bhature", "fried bread", "leavened bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  patientFriendly: ["general"],
  pantryKeywords: ["flour", "salt", "oil"],
  searchKeywords: ["roomali roti", "thin bread", "handkerchief bread", "bread", "flatbread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  pantryKeywords: ["flour", "besan", "onion", "green chili", "cumin seeds", "red chili", "turmeric", "ghee"],
  searchKeywords: ["missi roti", "gram flour roti", "spiced flatbread", "rajasthani bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart"],
  pantryKeywords: ["flour", "besan", "methi", "ginger chili paste", "cumin seeds", "red chili", "turmeric", "yogurt"],
  searchKeywords: ["thepla", "methi thepla", "gujarati bread", "travel bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
  ...
  ageGroup: ["adults", "kids", "seniors"],
  patientFriendly: ["general", "diabetes", "heart"],
  pantryKeywords: ["cornmeal", "salt", "ghee"],
  searchKeywords: ["makki di roti", "cornmeal bread", "winter bread", "punjabi bread", "bread"],
  isFeatured: false,
  averageRating: 0,
  totalRatings: 0,
  timesSuggested: 0,
    ...
    for (let recipe of recipesToMigrate) {
      try {
        ...
        if (!existing) {
          ...
          console.log(`Skipped: ${recipe.title} (already in database)`);
          skipped++;
        }
      } catch (err) {
