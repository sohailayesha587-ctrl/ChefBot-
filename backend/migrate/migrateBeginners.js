...
const cookingMethods = [
  {
    ...
    fullDesc: "Boiling is a moist and heat cooking method where food is submerged in water at 100°C (212°F). This method is excellent for cooking pasta, vegetables, eggs, and grains. It is a fast cooking method that retains nutrients when done properly.",
  ...
  },
  {
    ...
    fullDesc: "Steaming cooks food by exposing it to steam from boiling water. This moist and heated method preserves nutrients, color, and texture better than boiling. Food doesn't touch the water, preventing nutrient loss.",
    ...
    tips: [
      "Do not let water touch food",
      "Use tight fitting lid",
      "Check water level",
      "Layer foods properly"
    ],
    steps: [
  ...
  },
  {
    ...
    fullDesc: "Sauteing cooks food quickly in a small amount of oil or fat over relatively high heat. The French word 'sauter' means 'to jump', referring to the tossing motion. This method creates flavorful browned surfaces while keeping interiors tender.",
    keyUses: ["Vegetables", "Meat pieces", "Shrimp", "Mushrooms"],
    previewImg: "SautingMethod.png",
    temperature: "Medium to high heat",
    equipment: "Skillet, Saute pan",
  ...
  },
  {
    ...
    fullDesc: "Pan-frying uses more oil than sauteing (about 1/4 to 1/2 inch deep) to cook food. The oil should come about halfway up the food. This method creates a crispy exterior while cooking the interior through conduction.",
  ...
  },
  {
    ...
    fullDesc: "Baking uses dry heat in an oven to cook food. Hot air circulates around the food, cooking it evenly. This method is ideal for foods that need structure development like bread, cakes, and casseroles.",
  ...
  },
  {
    ...
    fullDesc: "Grilling cooks food with direct radiant heat from below. This method creates marks and smoky flavor. Perfect for quick cooking foods that benefit from high heat and caramelization.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Remove meat and saute vegetables.",
  ...
  },
  {
    ...
    keyUses: ["Beef stew", "Curries", "Chilli"],
...
const cuttingTechniques = [
  {
    ...
    fullDesc: "Julienne is a knife technique that produces thin, matchstick sized strips of vegetables or fruits. It is 5-7cm long. It is essential for dishes that require quick cooking and uniform texture.",
    ...
    tips: [
      ...
      "Create planks first, then strips",
  ...
  },
  {
    ...
    fullDesc: "Brunoise is an extremely fine dice cut. It's the smallest of the dice cuts and requires precision knife work. Often used for garnishes or ingredients that need to cook quickly or melt into dishes.",
    ...
    tips: [
      ...
      "Keep knife very sharp"
    ],
    steps: [
      "Start with julienne-cut vegetables (strips).",
  ...
  },
  {
    ...
    fullDesc: "Chiffonade is a technique for cutting leafy herbs and vegetables into thin, ribbon like strips. Meaning 'made of rags' in French, it is perfect for herbs and leafy greens where you want maximum flavor and elegant presentation.",
    keyUses: ["Herb garnishes", "Salads", "Pasta dishes", "Garnishes"],
    previewImg: "ChiffonadeCut.png",
    knife: "Chef's knife",
    tips: [
      "Stack leaves neatly",
      "Roll tightly before cutting",
  ...
  },
  {
    ...
    knife: "Chef's knife",
    tips: [
      "Create planks then batons",
      "Maintain consistent pressure",
      "Use cutting board anchors"
    ],
    steps: [
  ...
  },
  {
    ...
    tips: [
      "Use rocking motion",
      "Keep slices even",
      "Anchor food with flat side down"
    ],
    steps: [
  ...
  },
  {
    ...
    fullDesc: "Batonnet produces stick shaped pieces, typically 5-6cm long. It's larger than julienne and serves as a starting point for medium dice cuts. Perfect for vegetables that will be served as side dishes or in stews.",
    keyUses: ["French fries", "Vegetable sticks", "Stir-fries"],
  ...
  },
  {
    ...
    fullDesc: "Tourne (or turned) is an advanced knife technique that produces seven sided and football shaped pieces. It is a decorative cut used in fine dining to create elegant vegetable presentations that cook evenly.",
    ...
    tips: [
      "Use small paring knife",
      "Practice on carrots first",
      "Maintain seven equal sides"
    ],
    steps: [
