...
const CookingMethodsPage = () => {
  ...
  const cookingMethods = [
    {
      ...
      fullDesc: "Boiling is a moist-heat cooking method where food is submerged in water at 100C (212F). This method is excellent for cooking pasta, vegetables, eggs, and grains. It's a fast cooking method that retains nutrients when done properly.",
    ...
    },
    {
      ...
      fullDesc: "Simmering cooks food in liquid at temperatures between 85-95C (185-203F). The liquid shows small bubbles and gentle movement. This method is perfect for delicate foods that need slow, even cooking without breaking apart.",
      keyUses: ["Soups", "Stews", "Sauces", "Grains"],
      previewImg: "SimmeringMethod.png",
      temperature: "85-95C (185-203F)",
    ...
    },
    {
      ...
      fullDesc: "Deep-frying completely submerges food in hot oil (typically 175-190C/350-375F). This creates a crispy, golden exterior while sealing in moisture. Proper temperature control is crucial to prevent oil absorption.",
      keyUses: ["French fries", "Chicken", "Doughnuts", "Fritters"],
      previewImg: "Deep-FryingMethod.png",
      temperature: "175-190C (350-375F)",
    ...
    },
    {
      ...
      fullDesc: "Roasting uses dry heat at high temperatures (usually above 200C/400F) to cook food, typically meat or vegetables. The high heat caramelizes the exterior while keeping the interior moist. Often used for larger cuts of meat.",
      keyUses: ["Whole chicken", "Vegetables", "Large meat cuts", "Nuts"],
      previewImg: "RoastingMethod.png",
      temperature: "200-230C (400-450F)",
    ...
    },
    {
      ...
      temperature: "Low heat (150C/300F)",
    ...
    },
    {
      ...
      keyUses: ["Beef stew", "Curries", "Chili", "Ragu"],
  ...
  const getMethodCardClass = (methodName) => {
    ...
    if (name.includes('saute')) return 'sauteing';
    ...
    <div className="cmp-container">
          ...
          <div className="cmp-sidebar-methods">
            <ul className="cmp-methods-list">
              {cookingMethods.map(method => (
                ...
                >
                  <i className="fas fa-utensils cmp-list-icon"></i>
                  ...
                  <div className="cmp-card-content">
                    ...
                    <div className="cmp-card-heat-type">
                      <span className={`cmp-heat-badge ${method.fullDesc.includes('moist') ? 'moist-heat' : 'dry-heat'}`}>
                        <i className={`fas ${method.fullDesc.includes('moist') ? 'fa-tint' : 'fa-fire'}`}></i>
            ...
            <div className="cmp-modal-content">
              <div className="cmp-modal-details">
                ...
                <div className="cmp-detail-section details-section">
                  <h3><i className="fas fa-cog cmp-icon"></i>Method Details</h3>
                  <div className="cmp-details-list">
                    <div className="cmp-detail-item">
                      <span className="cmp-detail-label"><i className="fas fa-thermometer-half cmp-detail-icon"></i> Temperature:</span>
                      <span className="cmp-detail-value">{selectedMethod.temperature}</span>
                    </div>
                    <div className="cmp-detail-item">
                      <span className="cmp-detail-label"><i className="fas fa-tools cmp-detail-icon"></i> Equipment:</span>
                      <span className="cmp-detail-value">{selectedMethod.equipment}</span>
                    </div>
                    <div className="cmp-detail-item">
                      <span className="cmp-detail-label"><i className="fas fa-bullseye cmp-detail-icon"></i> Best For:</span>
                ...
                <div className="cmp-detail-section steps-section">
                  <h3><i className="fas fa-list-ol cmp-icon"></i>Steps to {selectedMethod.name}</h3>
                ...
                <div className="cmp-detail-section tips-section">
                  <h3><i className="fas fa-lightbulb cmp-icon"></i>Pro Tips</h3>
                  <div className="cmp-tips-list">
                    {selectedMethod.tips.map((tip, idx) => (
                      <div key={idx} className="cmp-tip-item">
                        <i className="fas fa-star cmp-tip-icon"></i>
                        <span>{tip}</span>
                      </div>
                    ))}
                  </div>
      ...
      <div className="back-home-container">
        <button className="back-home-btn" onClick={() => navigate('/guidance')}>
          <i className="fas fa-arrow-left cmp-back-icon"></i> Back to Guidance Page
        </button>
      </div>
    </div>
  );
