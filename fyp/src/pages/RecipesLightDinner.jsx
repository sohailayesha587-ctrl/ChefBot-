...
const RecipesLightDinner = () => {
  ...
  useEffect(() => {
fetch('http://localhost:5000/api/recipes/subCategory/light-dinner?limit=200')
      .then(res => res.json())
      .then(data => {
    ...
    <div className="light-dinner-page">
      <header className="light-dinner-header">
        <div className="light-dinner-header-content">
          <h1 className="light-dinner-title">🍽️ Recipe Collection</h1>
          <p className="light-dinner-description">
            Discover delicious recipes - rice, qeema, beverages, curries, and much more!
          </p>
        </div>
      </header>
            ...
            {recipes.map((recipe) => (
              ...
              >
                ...
                <div className="light-dinner-card-content">
                  <h3 className="light-dinner-card-title">{recipe.title}</h3>
