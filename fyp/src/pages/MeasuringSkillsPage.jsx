                  ...
                  {selectedCategory === 'estimation' && selectedItem && (
                    <>
                      ...
                      {selectedItem.indicators && selectedItem.indicators.length > 0 && (
                        <div className="msp-detail-section">
                          <h3>Visual & Sensory Indicators</h3>
