  ...
  const breadRecipes = [
    ...
    { 
      ...
      steps: [
        ...
        "In a bowl, mix mashed potatoes with chopped onions, green chilies, cumin powder, red chili powder, garam masala, amchur powder, salt, and fresh coriander.",
    ...
    { 
      ...
      steps: [
        ...
        "Squeeze out excess water from the grated cauliflower.",
    ...
    { 
      ...
      steps: [
        "Knead the dough with flour, salt, and water. Rest for 30 minutes.",
        "Squeeze out all the water from the grated radish. Radish releases a lot of water.",
    ...
    { 
      ...
      steps: [
        "Knead the dough with flour, salt, and water. Rest for 30 minutes.",
        "In a bowl, mix grated paneer with onions, green chilies, cumin powder, red chili powder, garam masala, salt, and coriander.",
        "Divide the filling into 8 portions.",
        "Divide the dough into 8 balls.",
    ...
    { 
      ...
      steps: [
        ...
        "In a small bowl, mix melted butter with finely chopped garlic and fresh coriander. Set aside.",
    ...
    { 
      ...
      steps: [
        "Prepare the naan dough as described in recipe #11. Let it rise for 2 hours.",
        "In a bowl, mix coconut, crushed almonds, pistachios, raisins, sugar, and cardamom powder.",
        "Divide the dough into 8 balls.",
    ...
    { 
      ...
      steps: [
        ...
        "Mix mashed potatoes with onions, green chilies, cumin seeds, red chili powder, amchur powder, salt, and coriander.",
    ...
    { 
      ...
      steps: [
        "Make the kulcha dough as described in recipe #21. Let it rest for 1 hour.",
        "Mix grated paneer with onions, green chilies, cumin powder, red chili powder, garam masala, salt, and coriander.",
        "Divide the filling into 8 portions. Divide the dough into 8 balls.",
        "Take one dough ball, flatten it, and place the paneer filling in the center.",
    ...
    { 
      ...
      steps: [
        "Mix mashed potatoes with onions, green chilies, chaat masala, red chili powder, and salt.",
    ...
    { 
      ...
      steps: [
        "Mix mashed potatoes with onions, green chilies, red chili powder, garam masala, salt, and coriander. Set aside.",
    ...
    { 
      ...
      steps: [
        "Mix cooked vegetables with onions, green chilies, chaat masala, red chili powder, salt, and coriander.",
    ...
    { 
      ...
      steps: [
        "Knead the dough with flour, salt, and water. Rest for 30 minutes.",
        "Mix grated jaggery, coconut, crushed nuts, and cardamom powder.",
