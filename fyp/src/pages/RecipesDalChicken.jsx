...
const RecipesDalChicken = () => {
  ...
  // ✅ FETCH CHICKEN + DAL RECIPES FROM BACKEND
  useEffect(() => {
fetch('http://localhost:5000/api/recipes/subCategory/dal-chicken?limit=200')
      ...
      .catch(error => {
        console.error('Error fetching chicken + dal recipes:', error);
        setLoading(false);
      });
  }, []);
    ...
    return (
      <div className="chicken-dal-page">
        <div className="loading-container">
          ...
          <p>Loading chicken + dal recipes...</p>
        </div>
      </div>
    );
  }
      ...
      <header className="chicken-dal-header">
        <div className="chicken-dal-header-content">
          ...
          <p className="chicken-dal-description">
            Discover delicious chicken and dal recipes - protein-rich, flavorful, and homestyle taste
          </p>
        </div>
      </header>
            ...
            {recipes.map((recipe) => (
              ...
              >
                ...
                <div className="chicken-dal-card-content">
                  <h3 className="chicken-dal-card-title">{recipe.title}</h3>
