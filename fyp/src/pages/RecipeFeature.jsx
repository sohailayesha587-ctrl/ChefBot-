...
const RecipeFeature = () => {
  ...
  const recipeTypes = [
    ...
    { id: 3, title: 'Main Course', description: 'Warm and comforting soups for all seasons', path: '/MainCourse', image: 'https://substackcdn.com/image/fetch/$s_!Xw3X!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdfa9ec03-d4e8-4946-9649-cf7fe4f34059_1442x1103.heic' },
    { id: 4, title: 'DESSERTS', description: 'Sweet delights and delicious treats', path: '/desserts', image: 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 5, title: 'BREAKFAST', description: 'Hearty main dishes for every occasion', path: '/BreakFast', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAAkO6PiyzExlXgDE-kZFg0VQlAt1sOqclhA&s' },
    { id: 6, title: 'BEVERAGES', description: 'Refreshing drinks for every mood', path: '/Beverage', image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 7, title: 'BAKING', description: 'Freshly baked goods and pastries', path: '/Baking', image: 'https://images.unsplash.com/photo-1483695028939-5bb13f8648b0?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 8, title: 'REGIONAL', description: 'Traditional and modern sweet dishes', path: '/Regional', image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 9, title: 'SALADS', description: 'Fresh and healthy salad recipes', path: '/Salads', image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 10, title: 'SNACKS', description: 'Quick bites and appetizers', path: '/Snack', image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
  ];
